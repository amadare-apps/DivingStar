...
Shader "DCG/Water/Lowpoly Water (Tessellation)"
{
	Properties
	{
		_Tessellation("Tessellation", Range( 1 , 9)) = 0
	...
	SubShader
	{
		...
		#pragma target 4.6
		#pragma surface surf StandardCustomLighting keepalpha vertex:vertexDataFunc tessellate:tessFunction 
		struct Input
		{
			float3 worldPos;
			float4 screenPos;
		...
		{
			float temp_output_8_0_g14 = 22.0;
			float2 temp_cast_0 = (temp_output_8_0_g14).xx;
			float3 ase_worldPos = mul( unity_ObjectToWorld, v.vertex );
			float2 appendResult2_g13 = (float2(ase_worldPos.x , ase_worldPos.z));
			float2 ifLocalVar21_g13 = 0;
			if( 0.0 <= 0.0 )
				ifLocalVar21_g13 = appendResult2_g13;
			else
				ifLocalVar21_g13 = ( 1.0 - appendResult2_g13 );
			float2 temp_output_7_0_g13 = ( ifLocalVar21_g13 * 0.0066 * 12.0 );
			float2 panner1_g14 = ( 0.015 * _Time.y * temp_cast_0 + temp_output_7_0_g13);
			float simplePerlin2D218 = snoise( panner1_g14 );
			float2 temp_cast_1 = (-temp_output_8_0_g14).xx;
			float2 panner2_g14 = ( 0.015 * _Time.y * temp_cast_1 + ( ( temp_output_7_0_g13 * 0.77 ) + float2( 0.33,0.66 ) ));
			float simplePerlin2D219 = snoise( panner2_g14 );
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float temp_output_2_0_g11 = ( ( eyeDepth14_g11 - ase_screenDepth ) * _Density );
			...
			float cameraDepthFade229 = (( ase_screenDepth -_ProjectionParams.y - 0.0 ) / 66.0);
			...
			float3 normalizeResult4_g12 = normalize( ( ase_worldViewDir + ase_worldlightDir ) );
			float dotResult146 = dot( normalizeResult4_g12 , normalizeResult115 );
...
/*ASEBEGIN
Version=15701
2017;158;1710;915;3468.588;2228.188;2.747777;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;87;-2202.443,-3919.458;Float;False;Property;_FoamScale;Foam Scale;18;0;Create;True;0;0;False;0;2;2;0.01;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;44;-1692.593,2038.284;Float;False;Property;_Distortion;Distortion;13;0;Create;True;0;0;False;0;0.1;0.1;0;0.66;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;88;-1846.039,-4257.933;Float;False;Property;_FoamSpeed;Foam Speed;17;0;Create;True;0;0;False;0;2;2;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;49;-1515.525,1810.605;Float;False;Property;_HardDistortion;Hard Distortion;12;0;Create;True;0;0;False;0;0;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;76;-2052.496,-3361.133;Float;False;Property;_FoamDistance;Foam Distance;16;0;Create;True;0;0;False;0;1.5;1.3;0;6;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;64;-1615.024,-3847.116;Float;True;Property;_Foam;Foam;15;1;[NoScaleOffset];Create;True;0;0;False;0;None;8d55201b19bb15042b89cb2ad7fc1280;False;white;Auto;Texture2D;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.RangedFloatNode;232;-3446.938,-2228.838;Float;False;Property;_RefractionChromaticAberration;Refraction Chromatic Aberration;14;0;Create;True;0;0;False;0;0;0.066;0;0.15;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;27;-2213.494,-2544.585;Float;False;Property;_Density;Density;5;0;Create;True;0;0;False;0;0.01;0.15;0.01;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;20;-2203.734,-2877.214;Float;False;Property;_WaterTint;Water Tint;3;0;Create;True;0;0;False;0;0.5235849,0.8924802,1,1;0.8160377,0.9529874,1,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;137;-2128.939,505.542;Float;False;Property;_Gloss;Gloss;10;0;Create;True;0;0;False;0;0.88;0.77;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;99;-961.6539,-3405.745;Float;False;Property;_FoamIntensity;Foam Intensity;19;0;Create;True;0;0;False;0;0;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;189;-2168.793,-761.6891;Float;False;Property;_ScatteringOffset;Scattering Offset;8;0;Create;True;0;0;False;0;-1;1.14;-6;6;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;175;-2187.959,931.3331;Float;False;Blinn-Phong Half Vector;-1;;12;91a149ac9d615be429126c95e20753ce;0;0;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode;249;-2164.409,-2400.633;Float;False;Property;_ScatteringTint;Scattering Tint;4;0;Create;True;0;0;False;0;0.5235849,0.8924802,1,1;0.3568627,0.6363447,0.7921569,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;220;-484.9589,938.5433;Float;False;WorldSpaceCoordDual;-1;;13;39024daf4a9269e428da367a6e63e26b;0;2;15;FLOAT;12;False;20;FLOAT;0;False;2;FLOAT2;0;FLOAT2;16
Node;AmplifyShaderEditor.RangedFloatNode;209;-1713.503,-908.4107;Float;False;Property;_ScatteringIntensity;Scattering Intensity;7;0;Create;True;0;0;False;0;0.45;0.4;0;6;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;159;-1742.095,940.0062;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;143;-2162.064,335.1668;Float;False;Property;_ReflectionFresnel;Reflection Fresnel;11;0;Create;True;0;0;False;0;6;5;0.1;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;214;-1383.468,-713.2832;Float;False;Property;_WaterEmission;Water Emission;6;0;Create;True;0;0;False;0;0.2;0.33;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;223;-427.5756,1059.323;Float;False;DualPanner;-1;;14;493d5f6edc56fb549b8eb8a84e9af86c;0;3;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT;22;False;2;FLOAT2;0;FLOAT2;9
...
Node;AmplifyShaderEditor.ToggleSwitchNode;217;-1659.533,1272.302;Float;False;Property;_UseSpecularGloss;Use Specular Gloss;9;0;Create;True;0;0;False;0;1;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;101;-471.1268,323.845;Float;False;Property;_ShoreBlendDistance;Shore Blend Distance;2;0;Create;True;0;0;False;0;0.02;0.02;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;225;207.7827,1147.347;Float;False;Property;_DisplacementNoisePower;Displacement Noise Power;20;0;Create;True;0;0;False;0;0.3;0.36;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;227;-64.16003,39.41306;Float;False;Property;_Tessellation;Tessellation;1;0;Create;True;0;0;False;0;0;3;1;9;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;358.232,-288.3465;Float;False;True;6;Float;ASEMaterialInspector;0;0;CustomLighting;DCG/Water/Lowpoly Water (Tessellation);False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;False;150;True;Transparent;;AlphaTest;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;True;1;3;10;25;False;0;True;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;0;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;0;14;227;0
ASEEND*/
//CHKSM=D5BDCC5C5AC5E67AE1B90523070BB43BF5001B45